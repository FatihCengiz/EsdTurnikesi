...
namespace EsdTurnikesi
{
    ...
    internal sealed class Ayarlar : ApplicationSettingsBase
    {
        ...
        [UserScopedSetting]
        [DebuggerNonUserCode]
        [DefaultSettingValue(@"192.168.1.1\servername")]
        ...
        [UserScopedSetting]
        [DebuggerNonUserCode]
        [DefaultSettingValue("database_name")]
        ...
        [UserScopedSetting]
        [DebuggerNonUserCode]
        [DefaultSettingValue("username_db")]
        ...
        [UserScopedSetting]
        [DebuggerNonUserCode]
        [DefaultSettingValue("password_db")]
